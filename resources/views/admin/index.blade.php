        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="#"><i class="fa fa-circle-o"></i> Edit Store</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-circle-o"></i>List Managers</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> Add Manager</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> Edit Manager</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
